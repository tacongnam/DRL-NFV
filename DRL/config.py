...
MAX_SIM_TIME_PER_EPISODE = 150 # Giới hạn thời gian mô phỏng (ms) để tránh lặp vô tận
...
GAMMA = 0.99
EPSILON_START = 1.0
EPSILON_DECAY = 0.9  # Giảm chậm hơn vì training lâu
EPSILON_MIN = 0.1
...
# Test Settings
TEST_EPSILON = 0.0  # No exploration during test
TEST_EPISODES = 5
TEST_FIG3_DCS = [2, 4, 6, 8] # Kịch bản thay đổi số lượng DC