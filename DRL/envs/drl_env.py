from DRL.envs.base_env import SFCBaseEnv
from DRL.envs.priority import PriorityManager
...
class DRLEnv(SFCBaseEnv):
    ...
    def __init__(self, dcs=None, topology=None, requests_data=None):
        super().__init__(dcs=dcs, topology=topology, requests_data=requests_data)
        self.priority_manager = None  # Will init in hook
